REM Simple script to start up the micro service using a Spring boot single JAR
REM To compile a single JAR type for example the following in the project root: mvn package -Pfredhopper -Pmicroservice-singlejar
REM
