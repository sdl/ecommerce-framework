# Install SDL Web E-Commerce OData micro service
#
...
$arguments += "--StartClass=com.sdl.ecommerce.odata.service.WinServiceContainer"
...
$arguments += "--StopClass=com.sdl.ecommerce.odata.service.WinServiceContainer"
